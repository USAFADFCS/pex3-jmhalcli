 ...
 * Documentation: I used https://www.geeksforgeeks.org/c/doubly-linked-list-in-c/, https://www.geeksforgeeks.org/c/doubly-linked-list-in-c/, and https://www.geeksforgeeks.org/dsa/insert-a-node-at-the-end-of-doubly-linked-list/ to help build my pqAccess() function. 
 * =========================================================== */
#include <stdio.h>
#include <stdlib.h>
#include "byutr.h"
